module Ladb::OpenCutList
  ...
  module SvgWriterHelper
    ...
    def _svg_write_start(file, width, height, unit_sign)
    ...
    def _svg_write_group_start(file, id = nil)
    ...
    def _svg_write_rect(file, x, y, width, height, stroke_color = nil, fill_color = nil, id = nil)
    ...
    def _svg_write_line(file, x1, y1, x2, y2, stroke_color = nil, id = nil)
