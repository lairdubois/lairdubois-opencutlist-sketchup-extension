    ...
    def run(step_by_step = false)
      ...
      result.packed_bins.each { |bin|
        ...
        bin.boxes.each { |box|
          ...
          _compute_part_projection_def(@part_drawing_type, box.data, true, true, {}, cuttingdiagram2d_def.projection_defs) unless @part_drawing_type == PART_DRAWING_TYPE_NONE
