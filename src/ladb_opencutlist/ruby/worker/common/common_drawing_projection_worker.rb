  ...
  class CommonDrawingProjectionWorker
    ...
    def run
      ...
      if @merge_holes
        ...
        through_paths.delete_if { |path| Clippy.get_rpath_area(path).abs < MINIMAL_PATH_AREA } # Ignore "artifact" paths generated by successive transformation / union / differences
