module Ladb::OpenCutList
  ...
  class PartDef
    ...
    attr_accessor :definition_id, :number, :saved_number, :name, :count, :scale, :raw_size, :size, :material_name, :material_origins, :cumulable, :orientation_locked_on_axis, :labels, :aligned_on_axes
