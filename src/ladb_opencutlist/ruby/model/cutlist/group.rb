module Ladb::OpenCutList
  ...
  class Group
    ...
    attr_reader :id, :material_id, :material_name, :material_display_name, :material_type, :material_color, :material_grained, :part_count, :std_available, :std_dimension_stipped_name, :std_dimension, :std_dimension_rounded, :std_width, :std_thickness, :total_cutting_length, :total_cutting_area, :total_cutting_volume, :total_final_area, :invalid_final_area_part_count, :show_cutting_dimensions, :show_edges, :edge_decremented, :parts
    ...
    def initialize(group_def, cutlist)
      ...
      @std_dimension_rounded = DimensionUtils.instance.rounded_by_model_precision?(group_def.std_width) || DimensionUtils.instance.rounded_by_model_precision?(group_def.std_thickness)
