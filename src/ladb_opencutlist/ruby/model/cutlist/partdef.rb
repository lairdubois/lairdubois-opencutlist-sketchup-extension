module Ladb::OpenCutList
  ...
  class PartDef
    ...
    attr_accessor :id, :definition_id, :number, :saved_number, :name, :is_dynamic_attributes_name, :count, :cutting_size, :size, :scale, :flipped, :material_name, :material_origins, :cumulable, :unit_price, :unit_mass, :labels, :length_increase, :width_increase, :thickness_increase, :orientation_locked_on_axis, :edge_count, :edge_pattern, :edge_entity_ids, :edge_length_decrement, :edge_width_decrement, :edge_decremented, :length_increased, :width_increased, :thickness_increased, :auto_oriented, :not_aligned_on_axes, :layers, :final_area, :children_warning_count, :children_length_increased_count, :children_width_increased_count, :children_thickness_increased_count
    ...
    def self.generate_part_id(group_id, definition, definition_attributes, instance_info, dynamic_attributes_name = false)
      ...
      Digest::MD5.hexdigest("#{group_id}|#{entity_id}|#{DimensionUtils.to_max_precision_f(instance_info.size.length).to_s}|#{DimensionUtils.to_max_precision_f(instance_info.size.width).to_s}|#{DimensionUtils.to_max_precision_f(instance_info.size.thickness).to_s}|#{instance_info.flipped.to_s}")
