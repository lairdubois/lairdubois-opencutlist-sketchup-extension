module Ladb::OpenCutList
  ...
  class Report
    ...
    attr_reader :errors, :warnings, :tips, :solid_wood_coefficient, :total_mass, :total_used_mass, :total_unused_mass, :total_cost, :total_used_cost, :total_unused_cost, :groups
