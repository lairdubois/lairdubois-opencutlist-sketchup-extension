module Ladb::OpenCutList
  ...
  class SheetGoodReportEntrySheet < AbstractReportItem
    ...
    attr_reader :volumic_mass, :std_price, :type, :length, :width, :count, :total_area, :total_used_area
  ...
  class DimensionalReportEntry < AbstractReportEntry
    ...
    def initialize(_def)
      ...
      @volumic_mass = @bars.map { |bar| bar.volumic_mass }.select { |volumic_mass| !volumic_mass.nil? }.uniq.join(', ')
  ...
  class DimensionalReportEntryBar < AbstractReportItem
    ...
    attr_reader :volumic_mass, :std_price, :type, :length, :count, :total_length, :total_used_length
