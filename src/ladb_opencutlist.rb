module Ladb
  module OpenCutList
    ...
    unless file_loaded?(__FILE__)
      ...
      when 'pt'
        ex.description = 'Planilha de Produção e Gerador de Plano de Corte de chapas e barras para marceneiros, carpinteiros e serralheiros. Código aberto, crowdfunded e fácil de usar ;)'
      when 'ru'
      ...
      when 'zz_pl'
        ex.description = '3 - Generator listy cięć i diagramów cięcia dla stolarzy. Open Source, finansowany społecznościowo i łatwy w użyciu ;)'
      when 'zz_pt'
