module Ladb
  module OpenCutList
    ...
    unless file_loaded?(__FILE__)
      ...
      ex.version     = "6.0.0-dev"  ## /!\ Auto-generated line, do not edit ##
      ...
      when 'zz_pl'
        ex.description = '3 - Generator listy cięć i schematów cięcia dla stolarzy. Open Source, crowdfunded i łatwy w użyciu ;)'
      when 'zz_pt'
        ex.description = '3 - Planilha de Produção e Gerador de Diagrama de Corte de chapas e pranchas MLC para marceneiros e carpinteiros. Código aberto, crowdfunded e fácil de usar ;)'
      when 'zz_ru'
