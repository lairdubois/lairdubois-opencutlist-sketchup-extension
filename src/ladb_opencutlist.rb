module Ladb
  module OpenCutList
    ...
    unless file_loaded?(__FILE__)
      ...
      when 'zz_pt'
        ex.description = '3 - Lista de Peças e Gerador de Plano de Corte de chapas e barras para marceneiros, carpinteiros e serralheiros. Código aberto, crowdfunded e fácil de usar ;)'
      when 'zz_ru'
